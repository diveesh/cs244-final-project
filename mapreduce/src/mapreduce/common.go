...
// Implementation of sort.Interface for sorting key-value pairs
type KeyValueList []KeyValue

func (slice KeyValueList) Len() int {
	return len(slice)
}

func (slice KeyValueList) Less(i, j int) bool {
	return slice[i].Key < slice[j].Key
}

func (slice KeyValueList) Swap(i, j int) {
